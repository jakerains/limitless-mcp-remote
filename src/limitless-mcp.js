...
export class LimitlessMCP extends McpAgent {
    ...
    setupTools() {
        this.server.tool('get_lifelogs', 'Get lifelog entries from a specific date', {
        ...
        this.server.tool('get_lifelog_by_id', 'Get a specific lifelog entry by ID', {
        ...
        this.server.tool('search_lifelogs', 'Search lifelog entries by query', {
        ...
        this.server.tool('delete_lifelog', 'Delete a lifelog entry by ID', {
